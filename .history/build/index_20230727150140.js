...
const userRoutes_1 = __importDefault(require("../TwitterBackend/build/routes/userRoutes"));
const tweetRoutes_1 = __importDefault(require("../TwitterBackend/build/routes//tweetRoutes"));
const authRoutes_1 = __importDefault(require("../TwitterBackend/build/routes//authRoutes"));
const authMiddleware_1 = require("../TwitterBackend/build/middlewares/authMiddleware");
